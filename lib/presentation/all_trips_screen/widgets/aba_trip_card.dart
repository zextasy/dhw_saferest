...
class AbaTripCard extends GetWidget<AllTripsController> {
  @override
  Widget build(BuildContext context) {
    return Container(
        width: double.infinity,
        margin: getMargin(left: 15, top: 56, right: 15),
                                                                  ...
                                                                  child: Stack(
                                                                      ...
                                                                      children: [
                                                                        Align(
                                                                            ...
                                                                            child: Padding(padding: getPadding(left: 7, top: 10, right: 10, bottom: 6), child: CommonImageView(svgPath: ImageConstant.imgGroupWhiteA700, height: getVerticalSize(4.00), width: getHorizontalSize(9.00)))),
                                                                        Align(
                                                                            alignment:
